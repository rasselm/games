...
func (_ tGames) List(
	...
	return revel.MainRouter.Reverse("Games.List", args).URL
}
...
func (_ tGames) Show(
	...
	return revel.MainRouter.Reverse("Games.Show", args).URL
}

func (_ tGames) Report(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("Games.Report", args).URL
}
